...
public class Handler{
    public static void main(String[] args) {
        String fromAddress = "bhagatyadav610@gmail.com";
        String toAddress = "rawatsushant2asb@gmail.com";
        String ccAddress = "sushant.rawat@ssipmt.com";
       Student student=new Student("Bhagat","1234567890","Software Developer");
        ...
        */
        ...
        Session session = Session.getInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("bhagatyadav610@gmail.com", Constant.PASSWORD);
            }
        });
        return session;
    }
